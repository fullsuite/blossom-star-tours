  ...
  return (
    <footer className="w-full pt-10 lg:pt-20">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-8 sm:gap-10 md:gap-12 xl:gap-16 text-neutral-500 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5  overflow-x-hidden pb-20 border-b border-wild-sand-200">
          {/* Company Info */}
          <div className="col-span-1 sm:col-span-3 md:col-span-3 lg:col-span-2 text-center lg:text-left">
            ...
            <p className="text-sm leading-6 text-body-secondary mx-auto lg:mx-0 md:max-w-[28rem] lg:max-w-[18rem]">
              There are many variations of lorem ipsum available but it is the
              majority of suffered that alteration in that some dummy text.
            </p>
            {/* Social Icons */}
        ...
        <div className="w-full py-6 flex flex-col sm:flex-row space-y-4 sm:space-y-0 justify-between items-center">
          ...
          <Image
            ...
            width={376}
            height={55}
            className="aspect-[376/55] object-contain w-auto h-10 xl:h-11 2xl:h-[3.4375rem] pointer-events-none"
          />
        </div>
      </div>
    </footer>
